    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 px-5 gap-5 mt-10">
                <button 
                    className="bg-[#ffffff] w-full shadow-2xl py-10 flex flex-col items-center rounded-3xl border-2 border-black cursor-pointer duration-200 hover:bg-[#c4c4c4] hover:scale-105 active:scale-100" 
                ...
                <button 
                    className="bg-[#ffffff] w-full shadow-2xl py-10 flex flex-col items-center rounded-3xl border-2 border-black cursor-pointer duration-200 hover:bg-[#c4c4c4] hover:scale-105 active:scale-100" 
                    onClick={() => router.push("/morning-activity")} 
                >
